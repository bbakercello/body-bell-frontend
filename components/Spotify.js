      ...
      <>
        <motion.a whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}>
          <Link
            ...
            href={`https://body-bell-frontend-git-v3-bbakercello.vercel.app/?client_id=${process.env.CLIENT_ID}&redirect_uri=${process.env.REDIRECT_URI}&response_type=${RESPONSE_TYPE}`}
          >
            <div className="pt-10">
