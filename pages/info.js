    ...
    <div>
      <Top_Nav/>
        ...
        <div className='flex flex-col pr-8 pl-8 bg-slate-100 rounded-lg'>
          ...
          <p>Until 1978 and the founding of Mute Records, there were few record labels devoted exclusively to electronic music. Due to a lack of exports, many early technological pioneers formed their own. For example, Juan Atkins founded the Detroit-based label Metroplex Records, and Richie Hawtin and John Acquaviva founded their influential Plus 8 label. In the UK, Warp Records became one of the preeminent sources of home listening and experimental music in the 1990s. Later additions included Astralwerks, Ninja Tune, Black Hole Recordings and Perfecto Record labels.</p>
          <br></br>
          </div>
          <h2 className='self-center text-2xl'>Body Bell Records was founded in 2022.</h2>
          <br></br>

          <p>Bell Records is an American record company founded in Boston in 1952 by Nick Stevens,  as a unit of Isnt It Fun LLC, after acquiring the rights to the Benny Bell name, Benny Bell used the Bell - Name sets records for bold novelty. </p>
          <br></br>
          <div>
